            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              {isAuthenticated && (
                <Button
                  ...
                  className="rounded-xl h-9 w-9 sm:h-10 sm:w-10 relative"
              ...
              <Button
                ...
                className="rounded-xl h-9 w-9 sm:h-10 sm:w-10 relative hidden sm:flex"
                aria-label="Wishlist"
              >
                ...
                <AnimatePresence>
                  {userMenuOpen && isAuthenticated && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0, scale: 1 }}
                      exit={{ opacity: 0, y: -10, scale: 0.95 }}
                      className="absolute right-0 top-14 w-56 bg-popover border border-border rounded-2xl shadow-2xl p-2 z-[60]"
                    >
